package home.kwyho.TipEstimation.gui;
...
*/
public class JFrameTipCalculator extends javax.swing.JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3555930730569425944L;
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				JFrameTipCalculator inst = new JFrameTipCalculator();
	...
	private void initGUI() {
		...
		try {
			...
			}
			{
				...
				jQuitButton.setBounds(302, 61, 73, 22);
